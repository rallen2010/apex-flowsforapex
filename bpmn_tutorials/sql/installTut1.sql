...
apex_string.join_clob(
  ...
  , q'[Note that the Lower Route has a '/' mark across the flow.  This demotes it is the default path.]'
  ...
  , q'[]'
  , q'[To instruct our gateway 'Gateway_Two' which way to go, you would set up a Process Variable with the routing instructions somewhere in your application before you get to the Gateway. ]'
  , q'[]'
